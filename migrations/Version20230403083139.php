 ...
 */
final class Version20230403083139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses ADD CONSTRAINT FK_1E512EC672C93255 FOREIGN KEY (id_question_id_id) REFERENCES questions (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses ADD CONSTRAINT FK_1E512EC66353B48 FOREIGN KEY (id_question_id) REFERENCES questions (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
